...
export default function InquiryForm() {
  ...
  return (
    <section id={FORM_SECTION_ID} className="section-padding bg-brand-50/60">
      <div className="container-main">
        <div className="embed-layout">
          <div className="space-y-5 lg:sticky lg:top-28">
            <div>
              <p className="section-label justify-center lg:justify-start">Get started</p>
              ...
              <p className="mx-auto mt-4 max-w-xl text-center text-lg leading-relaxed text-ink/80 lg:mx-0 lg:text-left">
                Complete the form and our team will reach out to discuss whether NeuroStar TMS is
                right for you. No obligation. We&apos;re here to answer questions and help you take
                the next step.
              </p>
              <p className="mx-auto mt-3 max-w-xl text-center text-sm text-brand-600 lg:mx-0 lg:text-left">
                Confidential. Takes about 2 minutes.
              </p>
            </div>

            <p className="text-center text-sm font-medium text-brand-700 lg:text-left">
              ...
              <li>
                <a href={PHONE_HREF} className="contact-item group">
                  ...
                  <span>
                    ...
                    <span className="mt-0.5 block font-medium text-brand-900 group-hover:text-brand-600">
                      {PHONE_NUMBER}
                    </span>
                  </span>
                </a>
              ...
              <li>
                ...
                >
                  ...
                  <span>
                    ...
                    <span className="mt-0.5 block font-medium leading-relaxed text-brand-900 group-hover:text-brand-600">
                      {ADDRESS}
                    </span>
                  </span>
                </a>
              ...
              <li>
                <div className="contact-item">
                  ...
                  <span>
                    ...
                    <span className="mt-0.5 block font-medium leading-relaxed text-brand-900">
                      {HOURS}
                    </span>
                  </span>
                </div>
            ...
            <p className="text-center text-sm text-brand-600 lg:text-left">
              Covered by most major insurance plans. No referral required.
            </p>
          </div>
